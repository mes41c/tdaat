...
export const calendarEvents: CalendarEvent[] = [
  ...
  { date: "02-20", title: "Fırat Yılmaz Çakıroğlu'nu Anma Günü", category: "anma", description: "20 Şubat 2015'te Ege Üniversitesi'nde alçak terör örgütü P*K tarafından şehit edilen Türk milliyetçisi Fırat Yılmaz Çakıroğlu'nun şehadet yıl dönümü.", country: "Türkiye" },
